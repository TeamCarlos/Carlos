...
local inline = {{{text="⚜┇قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/H_GG_H"}}}
send_key(msg.sender_user_id_,'  [⚜┇قناة سورس : كـارلـوس](t.me/H_GG_H)',nil,inline,msg.id_)
return false
end

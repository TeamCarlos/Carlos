...
local inline = {{{text="⚜┇قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/HXX_X"}}}
send_key(msg.sender_user_id_,'  [⚜┇قناة سورس : كـارلـوس](t.me/HXX_X)',nil,inline,msg.id_)
return false
end
...
✨┇ومبروك نصبت سورس كارلوس تيجي الجديد ع توكن
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
💭┇كود رن السورس 
`./MAX/run`
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
...
👨🏽‍⚖️┇بالتـوفيـق عزيزي ...
🎁┇[اضغط هنا لديك مفاجئه](https://t.me/H_GG_H)
]] )
--=====================================
